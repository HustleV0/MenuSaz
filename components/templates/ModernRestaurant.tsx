...
export function ModernRestaurant({ restaurant }: { restaurant: Restaurant }) {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            <Link href={`/preview/${restaurant.slug}`} className="text-sm font-bold uppercase tracking-widest hover:text-[#e17055] transition-colors">منو</Link>
        ...
        <div className="container mx-auto px-6 h-16 flex items-center gap-8 min-w-max">
            ...
            {mockCategories.map(cat => (
                <button 
                    ...
                    className={`text-sm font-bold uppercase tracking-tighter transition-all ${activeCategory === cat.id ? 'text-[#e17055] border-b-2 border-[#e17055]' : 'opacity-40 hover:opacity-100'} h-full px-2`}
                >
                    {cat.name}
                </button>
            ))}
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex gap-10">
                    <Link href="#" className="text-xs font-bold uppercase tracking-widest opacity-40 hover:opacity-100 transition-opacity">اینستاگرام</Link>
                    <Link href="#" className="text-xs font-bold uppercase tracking-widest opacity-40 hover:opacity-100 transition-opacity">تلگرام</Link>
                    <Link href="#" className="text-xs font-bold uppercase tracking-widest opacity-40 hover:opacity-100 transition-opacity">واتساپ</Link>
                </div>
            </div>
        </div>
      </footer>
