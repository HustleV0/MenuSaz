...
export function MinimalCafe({ restaurant }: { restaurant: Restaurant }) {
            ...
            {activeCategory || searchQuery ? (
              <section>
                <h2 className="mb-4 text-xl font-bold">
                  {searchQuery ? "نتایج جستجو" : mockCategories.find((c) => c.id === activeCategory)?.name}
                </h2>
              ...
              {product.discountPrice ? (
                <>
                  <span className="font-bold text-primary">
                    {formatPrice(product.discountPrice)} {restaurant.settings.currency}
                  </span>
                ...
                <span className="font-bold">
                  {formatPrice(product.price)} {restaurant.settings.currency}
                </span>
              )}
            </div>
          )}
